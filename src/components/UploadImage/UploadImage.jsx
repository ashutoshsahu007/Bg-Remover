...
const UploadImage = () => {
  ...
  return (
    <div className=" m-auto bg-white sm:shadow-[0px_0px_50px_10px_rgba(0,0,0,0.1)] rounded-4xl  md:w-[300px] md:h-[346px] flex items-center justify-center flex-col gap-4">
      {/* Hidden Input with Label acting as a button */}
      <label className="font-medium text-2xl cursor-pointer rounded-full  text-white bg-[#007bff] px-10 py-3">
        Upload Image
        <input
          type="file"
          accept="image/*"
